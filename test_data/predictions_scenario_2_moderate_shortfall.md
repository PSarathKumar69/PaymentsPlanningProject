# Prediction — Scenario 2 — Moderate shortfall

Available Funds: Rs 7,500,000.00

- guaranteed_total (Must Pay + Commitment): Rs 5,290,000.00
- escalation: False (escalation_shortfall: Rs 0.00)
- bucket_pct: {'P2': 0.75, 'P3': 0.65, 'P4': 0.6, 'P5': 0.25}
- exceptional_shortfall: False
- leftover_topup_total: Rs 49,500.00
- leftover_remaining: Rs 0.00
...
| NM2P2-01 | Horizon Pumps | Normal | P2 | only_current | 200,000.00 | 160,000.00 | partial |
| NM2P2-02 | Indus Valves | Normal | P2 | current_zero_oldest_only | 150,000.00 | 120,000.00 | partial |
| NM2P2-03 | Jupiter Cables | Normal | P2 | oldest_and_current | 380,000.00 | 304,000.00 | partial |
| NM2P2-04 | Kavya Chemicals | Normal | P2 | oldest_and_second | 100,000.00 | 80,000.00 | partial |
| NM2P2-05 | Lotus Paints | Normal | P2 | oldest_only | 350,000.00 | 262,500.00 | partial |
| NM2P2-06 | Mahalaxmi Foods | Normal | P2 | no_outstanding | 0.00 | (excluded — zero outstanding balance) | n/a |
| NM2P2-07 | Nandi Agro | Normal | P2 | only_current | 90,000.00 | 72,000.00 | partial |
| NM2P3-01 | Omega Plastics | Normal | P3 | current_zero_oldest_only | 120,000.00 | 78,000.00 | partial |
| NM2P3-02 | Pioneer Glass | Normal | P3 | oldest_and_current | 250,000.00 | 162,500.00 | partial |
| NM2P3-03 | Quantum Electricals | Normal | P3 | oldest_and_second | 100,000.00 | 65,000.00 | partial |
| NM2P3-04 | Ravi Timber | Normal | P3 | oldest_only | 300,000.00 | 195,000.00 | partial |
| NM2P3-05 | Sapphire Foods | Normal | P3 | no_outstanding | 0.00 | (excluded — zero outstanding balance) | n/a |
| NM2P3-06 | Trident Hardware | Normal | P3 | only_current | 250,000.00 | 162,500.00 | partial |
| NM2P4-01 | Unity Motors | Normal | P4 | only_current | 180,000.00 | 108,000.00 | partial |
| NM2P4-02 | Vishal Plywood | Normal | P4 | current_zero_oldest_only | 90,000.00 | 54,000.00 | partial |
| NM2P4-03 | Wave Enterprises | Normal | P4 | oldest_and_current | 190,000.00 | 114,000.00 | partial |
| NM2P4-04 | Xanadu Sports | Normal | P4 | oldest_and_second | 70,000.00 | 45,500.00 | partial |
| NM2P4-05 | Yamuna Dairy | Normal | P4 | oldest_only | 220,000.00 | 132,000.00 | partial |
| NM2P4-06 | Zenith Tools | Normal | P4 | no_outstanding | 0.00 | (excluded — zero outstanding balance) | n/a |
| NM2P5-01 | AeroTech Salvage | Inactive | P5 | current_zero_oldest_only | 60,000.00 | 15,000.00 | partial |
| NM2P5-02 | Bygone Traders | Inactive | P5 | oldest_and_current | 130,000.00 | 32,500.00 | partial |
| NM2P5-03 | Closing Chapter Textiles | Inactive | P5 | oldest_and_second | 40,000.00 | 10,000.00 | partial |
| NM2P5-04 | Discontinued Devices | Inactive | P5 | oldest_only | 150,000.00 | 37,500.00 | partial |
