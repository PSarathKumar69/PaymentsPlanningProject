"""One-off: build a 15-real-vendor demo Excel from the real master sheet.
...
and the first 15 real vendor data rows (rows 4-18) verbatim as literal
values + number formats + column widths into a new workbook.

Not part of the app — run once, then discard. Supersedes build_demo20.py's
20-vendor file (that demo file was deleted; this is a smaller, fresh replacement,
not an edit of the 20-row one).
"""
import copy
...
DST = "data/Vendor's Details (Demo 15).xlsx"
HEADER_ROWS = 3
DEMO_VENDOR_ROWS = 15
